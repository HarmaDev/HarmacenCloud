...
// MailApp.sendEmail(oslugr@gmail.com, "Nueva recogida material", "Material a recoger: "+ '\n'+ datos);
...
//MailApp.sendEmail(oslugr@gmail.com, "Error report: ", "Ha habido un error en el formulario de recogidas. Mensaje:"+'\n'+e.message);
}
}
catch (f2) {
